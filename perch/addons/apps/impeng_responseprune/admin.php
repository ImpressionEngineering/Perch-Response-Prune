<?php
   	...
   	$this->register_app('impeng_responseprune', 'Form Response Pruning ( WARNING: This will permanently DELETE your form responses )', 9, 'Perch addon to prune form responses from the database', '0.5', true);
